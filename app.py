...
# mongodbnya
# password = 'Ardiansyah955'
# cs =f'mongodb+srv://randhyar955:{password}@cluster0.vr2df0r.mongodb.net/'
...
def home():
    ...
    try:
        ...
        # decode mengubah menjadi library
        # payload yang akan mengubahnya semua menajdi dictionary
        # except lebih keerror
        ...
        return redirect(url_for('login', msg=msg))
        # sha256 lebih securenya, lebih aman, 
...
def posting():
    ...
    try:
        ...
        user_info = db.users.find_one({'username' : payload.get('id')})
        comment_reveice = request.form.get('comment_give')
